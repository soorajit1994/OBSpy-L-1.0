...
function SetFooter(){
  ...
  if (!window.top.document.head.contains(window.top.document.getElementById("style_id"))) {
    var css = '.my_foot {\
       position: fixed;\
       left: 0;\
       bottom: 0;\
       ...
       z-index:9999;\
        ...
        head = window.top.document.head || window.top.document.getElementsByTagName('head')[0],
    ...
    if (style.styleSheet){
      ...
      var btn = window.top.document.createElement("DIV");
      btn.innerText=" Object Picker ";
      btn.setAttribute("class", "my_foot");
      btn.setAttribute("id", "my_foot_id");
      if(!window.top.document.body.contains(window.top.document.getElementById("my_foot_id"))){
        ...
        for (e=0;e<elements.length;e++){
            ...
            if(!X.endsWith("']")&&!X.startsWith("html")){
                ...
                if(PX.startsWith("html")){
                    ...
                    console.log("PFailed Initiallly",MERGED,elements[e],document.title)
...
document.body.addEventListener('mouseover', MouseInListenerFunction,true);
    ...
    function MouseInListenerFunction(event){
       ...
       //// document= event.target.contentWindow.document;
        ...
        window.top.document.getElementById("my_foot_id").innerHTML=FOOT
